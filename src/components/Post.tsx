        ...
        <Container>
            ...
            <Grid container className={classes.root}>
                ...
                <Grid item xs={8} className={classes.sub}>
                    <Grid container>
                        <Grid item xs={9}>
                            <Typography variant="h4">By: {author}  <Clap className={classes.clap} onClick={handleClapPost}/>{clapCount}</Typography>
                        </Grid>
                        <Grid item xs={3}>
                            <Typography variant="h5" className={classes.dateCreated}>{dateCreated}</Typography>
                        </Grid>
                    </Grid>
                </Grid>
                <Grid item xs={4} className={classes.sub}>
                    <Button fullWidth className={classes.deletePost} onClick={handleDeletePost}>Delete Post</Button>
                </Grid>
